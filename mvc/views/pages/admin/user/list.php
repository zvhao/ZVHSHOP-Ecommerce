    ...
    <tbody>
        ...
        ?>
                <tr>
                    ...
                    <td class="align-middle "><img src="<?= !empty($user['avatar'])? _PATH_AVATAR . $user['avatar']: _PATH_IMG_PUBLIC . 'profile.jpg' ?>" class="align-middle img-thumbnail" style="width: 80px; height: 80px; margin-top: 5px; max-width: 100%; object-fit: cover; object-position: center;"></td>
